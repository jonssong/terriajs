...
var Cesium = require('terriajs-cesium/Source/Cesium'); //GJO WSP
...
//start GJO WSP hack as we wait for proper 3d tile support 
function add3Dtiles(viewer) {
    viewer.terria.cesium.scene.primitives.add(new Cesium.Cesium3DTileset({
        url : 'http://www.loganinteractivemapping.com.au/3d_data/cesium_tiles/Beenleigh/root.json'
    }));
}
// end GJO WSP
